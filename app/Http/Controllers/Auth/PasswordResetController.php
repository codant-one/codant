...
class PasswordResetController extends Controller
{
    ...
    public function email_confirmation(Request $request)
    {
        ...
        $data = [
            ...
            'text' => env('APP_NAME').' le informa, que hemos recibido su solicitud para renovar su contraseña. Por favor, confirme dicha solicitud haciendo clic en el enlace a continuación: ',
            'buttonLink' =>  $url ?? null,
