...
$(document).ready(function () {
    ...
    $(document).delegate('.delete-item', 'click', function () {
        Swal.fire({
            title: lang.js_common.are_you_sure,
            text: lang.js_common.wont_be_able,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#FFFFFF',
            confirmButtonText: lang.js_common.button_delete,
            cancelButtonText: lang.js_common.button_cancel,
            customClass: {
                confirmButton: 'btn btn-info rounded-pill',
                cancelButton: 'border btn btn-outline ms-3 rounded-pill btn-active-light-primary',
            }
        }).then((result) => {
    ...
    $(document).delegate('.approve-item', 'click', function () {
        Swal.fire({
            ...
            confirmButtonText: lang.js_common.button_approve,
            cancelButtonText: lang.js_common.button_cancel
        }).then((result) => {
            if (result.isConfirmed) {
                $(this).closest('form').submit();
    ...
    $(document).delegate('.disapprove-item', 'click', function () {
        Swal.fire({
            ...
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            confirmButtonText: lang.js_common.button_disapprove,
            cancelButtonText: lang.js_common.button_cancel
        }).then((result) => {
            if (result.isConfirmed) {
                $(this).closest('form').submit();
