                            ...
                            <div class="col-lg-6">
                                <div class="p-lg-5 p-4">
                                    <div class="mb-2 mb-md-4">
                                        <div class="avatar-md avatar-md-lg mx-auto">
                                    ...
                                    <div class="text-muted text-center mx-lg-3">
                                        <h4 class="d-none d-md-block">Verifica tu código de autenticación</h4>
                                        <h4 class="d-block d-md-none mb-0">Código de autenticación</h4>
                                        <p>
                                            Por favor ingresa el código de 6 dígitos 
                                            <span class="d-none d-md-block">generado por tu app de autenticación (Google Authenticator, Authy, etc).</span>
                                        </p>
                                    </div>
