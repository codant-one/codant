                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-grow-1">
                            <lord-icon
                                src="https://cdn.lordicon.com/fhtaantg.json" trigger="loop" colors="primary:#151426,secondary:#0ab39c" style="width:55px;height:55px">
                            </lord-icon>
                        </div>
        ...
        <div class="col-xxl-3 col-md-6">
            <div class="card card-animate">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-grow-1">
                            <lord-icon src="https://cdn.lordicon.com/qhviklyi.json" trigger="loop" colors="primary:#151426,secondary:#0ab39c" style="width:55px;height:55px"></lord-icon>
                        </div>
                        <div class="flex-shrink-0">
                            <a href="javascript:void(0);" class="badge bg-warning-subtle text-warning badge-border">BTC</a>
                            <a href="javascript:void(0);" class="badge bg-info-subtle text-info badge-border">ETH</a>
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-grow-1">
                            <lord-icon
                                ...
                                trigger="loop"
                                colors="primary:#151426,secondary:#0ab39c"
                                ...
                                <div class="d-flex mb-3">
                                    <div class="flex-grow-1">
                                        <lord-icon
                                            ...
                                            colors="primary:#151426,secondary:#0ab39c" style="width:55px;height:55px">
                                        </lord-icon>
                                    </div>
                                    <div class="flex-shrink-0">
