                ...
                <div class="table-responsive table-card">
                    <table class="table align-middle table-nowrap table-hover" id="customerTable">
                        ...
                        <tbody class="list form-check-all">
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('build/images/nft/img-01.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Abstract Face Painting</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Patterns Arts & Culture</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('build/images/nft/img-02.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Creative Filtered Portrait</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Long-tailed Macaque</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('build/images/nft/img-04.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Robotic Body Art</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('build/images/nft/img-06.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Smillevers Crypto</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.themesbrand.com/velzon/images/img-5.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">The Chirstoper</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="https://img.themesbrand.com/velzon/images/img-3.gif" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Walking On Air</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('build/images/nft/img-05.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">The Chirstoper</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('build/images/nft/img-03.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Walking On Air</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="collection">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset('build/images/nft/img-04.jpg')}}" alt="" class="avatar-xs rounded-circle object-fit-cover me-2"> <a href="{{ route('template.index', 'apps-nft-item-details') }}" class="text-body">Highstreet IHO Part</a>
                                    </div>
                                </td>
                    ...
                    <div class="noresult" style="display: none">
                        <div class="text-center">
                            <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#151426,secondary:#0ab39c" style="width:75px;height:75px"></lord-icon>
