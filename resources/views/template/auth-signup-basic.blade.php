                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="mt-4 text-center">
                                <p class="mb-0">Already have an account ? <a href="{{ route('template.index', 'auth-signin-basic') }}" class="fw-semibold text-primary text-decoration-underline"> Signin </a> </p>
                            </div>
