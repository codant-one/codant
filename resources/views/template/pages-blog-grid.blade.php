...
@section('content')
    ...
    <div class="row g-4 mb-3">
        <div class="col-sm-auto">
            <div>
                <a href="{{ route('template.index', 'apps-projects-create') }}" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add
                    New</a>
            </div>
        </div>
        <div class="col-sm">
    ...
    <div class="row">
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-reset">The Mindful Journal</a>
                    </h5>
                    ...
                    <a href="{{ route('template.index', 'pages-blog-overview') }}" class="link link-primary text-decoration-underline link-offset-1">Read
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-reset">Next Gen Creators</a></h5>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-reset">The Thought Canvas</a></h5>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-reset">The Insight Collective</a>
                    </h5>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-reset">Life by Design</a></h5>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-reset">Crafted Perspectives</a>
                    </h5>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-reset">Beyond the Blueprint</a>
                    </h5>
        ...
        <div class="col-xxl-3 col-lg-6">
            <div class="card overflow-hidden blog-grid-card">
                ...
                <div class="card-body">
                    <h5 class="card-title"><a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-reset">The Imagination
                            Engine</a></h5>
