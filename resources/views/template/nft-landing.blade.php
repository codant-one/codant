...
<body data-bs-spy="scroll" data-bs-target="#navbar-example">
    ...
    <div class="layout-wrapper landing">
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light fixed-top" id="navbar">
            <div class="container">
                <a class="navbar-brand" href="{{ route('template.root') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="{{ route('template.index', 'apps-nft-wallet') }}" class="btn btn-success">Wallet Connect</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center">
                            ...
                            <div class="hstack gap-2 justify-content-center">
                                <a href="{{ route('template.index', 'apps-nft-create') }}" class="btn btn-primary">Create Own <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                                <a href="{{ route('template.index', 'apps-nft-explore') }}" class="btn btn-danger">Explore Now <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                    <!--end col-->
                    ...
                    <div class="col-lg-4 product-item artwork crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Creative Filtered Portrait</a></h5>
                    ...
                    <div class="col-lg-4 product-item music crypto-card games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="{{ route('template.index', 'apps-nft-item-details') }}">The Chirstoper</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music games">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Evolved Reality</a></h5>
                    ...
                    <div class="col-lg-4 product-item crypto-card 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Abstract Face Painting</a></h5>
                    ...
                    <div class="col-lg-4 product-item games music 3d-style">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Long-tailed Macaque</a></h5>
                    ...
                    <div class="col-lg-4 product-item artwork music crypto-card">
                        <div class="card explore-box card-animate">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="mb-1"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Robotic Body Art</a></h5>
                                <p class="text-muted mb-0">Artwork</p>
                            </div>
                            <div class="card-footer border-top border-top-dashed">
                                <div class="d-flex align-items-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <a href="{{ route('template.index', 'apps-nft-explore') }}" class="btn btn-primary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
                        </div>
                    </div>
                </div><!-- end row -->
                <div class="row">
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Patterns arts &amp; culture</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Evolved Reality</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card explore-box card-animate border">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <h6 class="fs-16 mb-0"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Long-tailed macaque</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        <a href="{{ route('template.index', 'pages-profile') }}">
            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-sm-auto">
                        <div>
                            <a href="{{ route('template.index', 'apps-nft-create') }}" class="btn bg-gradient btn-danger">Create NFT</a>
                            <a href="{{ route('template.index', 'apps-nft-explore') }}" class="btn bg-gradient btn-info">Discover More</a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                            ...
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li><a href="{{ route('template.index', 'pages-profile') }}">About Us</a></li>
                                        <li><a href="{{ route('template.index', 'pages-gallery') }}">Gallery</a></li>
                                        <li><a href="{{ route('template.index', 'apps-projects-overview') }}">Projects</a></li>
                                        <li><a href="{{ route('template.index', 'pages-timeline') }}">Timeline</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li><a href="{{ route('template.index', 'pages-pricing') }}">Calendar</a></li>
                                        <li><a href="{{ route('template.index', 'apps-mailbox') }}">Mailbox</a></li>
                                        <li><a href="{{ route('template.index', 'apps-chat') }}">Chat</a></li>
                                        <li><a href="{{ route('template.index', 'apps-crm-deals') }}">Deals</a></li>
                                        <li><a href="{{ route('template.index', 'apps-tasks-kanban') }}">Kanban Board</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li><a href="{{ route('template.index', 'pages-faqs') }}">FAQ</a></li>
                                        <li><a href="{{ route('template.index', 'pages-faqs') }}">Contact</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
