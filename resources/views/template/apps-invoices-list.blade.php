                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <a href="{{ route('template.index', 'apps-invoices-create') }}" class="btn btn-danger"><i class="ri-add-line align-bottom me-1"></i> Create Invoice</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-body p-5 text-center">
                                <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop" colors="primary:#151426,secondary:#f06548" style="width:90px;height:90px">
                                </lord-icon>
