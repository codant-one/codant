            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('template.index', 'pages-pricing') }}" class="text-reset text-decoration-underline"><b>Upgrade</b></a>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-8">
                            <div class="p-3">
                                ...
                                <div class="mt-3">
                                    <a href="{{ route('template.index', 'pages-pricing') }}" class="btn btn-success">Upgrade Account!</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-8">
                            <div class="p-3">
                                ...
                                <div class="mt-3">
                                    <a href="{{ route('template.index', 'pages-pricing') }}" class="btn btn-info">Upgrade Account!</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('template.index', 'pages-pricing') }}" class="text-reset text-decoration-underline"><b>Get Free
                                    Gift</b></a>
                        </div>
                    </div>
                    <div class="d-flex p-3">
                        ...
                        <div>
                            ...
                            <div class="mt-3">
                                <a href="{{ route('template.index', 'pages-pricing') }}" class="btn btn-secondary">Get a Free Gift</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card-body-->
                            ...
                            <div data-simplebar style="max-height: 364px;" class="p-3">
                                <div class="acitivity-timeline acitivity-main">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2 w-75">
                                                <a href="{{ route('template.index', 'apps-ecommerce-product-details') }}" class="bg-light rounded p-1">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1">Today offers by <a href="{{ route('template.index', 'apps-ecommerce-seller-details') }}"
                    ...
                    <div class="notification-elem" id="notification-overlay">
                        <div class="text-center">
                            <lord-icon src="https://cdn.lordicon.com/lupuorrc.json" trigger="loop"
                                colors="primary:#0ab39c,secondary:#151426" style="width:120px;height:120px"></lord-icon>
                            <div class="mt-4 pt-2">
