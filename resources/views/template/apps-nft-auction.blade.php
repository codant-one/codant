            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-16 mb-3"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Abstract Face Painting</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-16 mb-3"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Patterns Arts & Culture</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-16 mb-3"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Creative Filtered Portrait</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-16 mb-3"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Smillevers Crypto</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                        <h6 class="fs-16 mb-3"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Long-tailed Macaque</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-16 mb-3"><a href="{{ route('template.index', 'apps-nft-item-details') }}">The Chirstoper</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="fs-16 mb-3"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Robotic Body Art</a></h6>
                        <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                <div class="card explore-box card-animate">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                        <h6 class="fs-16 mb-3"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Evolved Reality</a></h6>
                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <a href="{{ route('template.index', 'apps-nft-item-details') }}">
