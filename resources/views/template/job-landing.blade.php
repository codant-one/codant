        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top job-navbar" id="navbar">
            <div class="container-fluid custom-container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <a href="{{ route('template.index', 'auth-signin-basic') }}" class="btn btn-soft-primary"><i class="ri-user-3-line align-bottom me-1"></i> Login & Register</a>
                    </div>
                </div>
                ...
                <div class="row align-items-center gy-4">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="text-muted mt-5 mt-lg-0">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('template.root') }}" class="btn btn-primary">View More Companies <i class="ri-arrow-right-line align-middle ms-1"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- end col -->
                    ...
                    <div class="col-lg-7 ms-lg-auto">
                        <div class="row">
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        ...
                                        <li><a href="{{ route('template.index', 'pages-team') }}">Team</a></li>
                                        <li><a href="{{ route('template.index', 'pages-pricing') }}">Pricing</a></li>
                            ...
                            <div class="col-sm-4 mt-4">
                                ...
                                <div class="text-muted mt-3">
                                    <ul class="list-unstyled ff-secondary footer-list">
                                        <li><a href="{{ route('template.index', 'apps-job-lists') }}">Job List</a></li>
                                        <li><a href="{{ route('template.index', 'apps-job-application') }}">application</a></li>
                                        <li><a href="{{ route('template.index', 'apps-job-new') }}">New Job</a></li>
                                        <li><a href="{{ route('template.index', 'apps-job-companies-lists') }}">Company List</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-4 mt-4">
                    ...
                    <div class="col-sm-6">
                        <div class="text-sm-end mt-3 mt-sm-0">
                            <ul class="list-inline mb-0 footer-list gap-4 fs-13">
                                <li class="list-inline-item">
                                    <a href="{{ route('template.index', 'pages-privacy-policy') }}">Privacy Policy</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="{{ route('template.index', 'pages-term-conditions') }}">Terms & Conditions</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="{{ route('template.index', 'pages-privacy-policy') }}">Security</a>
                                </li>
                            </ul>
                        </div>
                    </div>
