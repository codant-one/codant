                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="mt-4 text-center">
                                <p class="mb-0">Didn't receive a code ? <a href="{{ route('template.index', 'auth-pass-reset-basic') }}" class="fw-semibold text-primary text-decoration-underline">Resend</a> </p>
                            </div>
