                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="{{ route('template.root') }}" class="d-inline-block auth-logo">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Wait, I remember my password... <a href="{{ route('template.index', 'auth-signin-basic') }}" class="fw-semibold text-primary text-decoration-underline"> Click here </a> </p>
                        </div>
