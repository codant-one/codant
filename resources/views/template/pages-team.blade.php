    ...
    <div class="col-lg-12">
        <div>
            ...
            <div class="py-4 mt-4 text-center" id="noresult" style="display: none;">
                <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#151426,secondary:#0ab39c" style="width:72px;height:72px"></lord-icon>
            ...
            <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="member-overview">
                ...
                <div class="offcanvas-foorter border p-3 hstack gap-3 text-center position-relative">
                    ...
                    <a href="{{ route('template.index', 'pages-profile') }}" class="btn btn-primary w-100"><i class="ri-user-3-fill align-bottom ms-1"></i> View Profile</a>
                </div>
            </div>
            <!--end offcanvas-->
        </div>
