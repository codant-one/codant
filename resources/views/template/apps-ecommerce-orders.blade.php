                    ...
                    <div class="table-responsive table-card mb-1">
                        <table class="table table-nowrap align-middle" id="orderTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td class="id"><a href="{{ route('template.index', 'apps-ecommerce-order-details') }}" class="fw-medium link-primary">#VZ2101</a></td>
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                <a href="{{ route('template.index', 'apps-ecommerce-order-details') }}" class="text-primary d-inline-block">
                        ...
                        <div class="noresult" style="display: none">
                            <div class="text-center">
                                <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#151426,secondary:#0ab39c" style="width:75px;height:75px">
                                </lord-icon>
