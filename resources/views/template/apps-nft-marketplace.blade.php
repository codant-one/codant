        ...
        <div class="card bg-primary" style="background-image: url('build/images/nft/bg-pattern.png');">
            <div class="card-body p-4">
                ...
                <div class="hstack gap-2">
                    <a href="{{ route('template.index', 'apps-nft-create') }}" class="btn btn-success">Create NFT</a>
                    <a href="{{ route('template.index', 'apps-nft-explore') }}" class="btn btn-danger">Explore Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        <div class="d-lg-flex align-items-center mb-4">
            ...
            <div class="flex-shrink-0 mt-4 mt-lg-0">
                <a href="{{ route('template.index', 'apps-nft-explore') }}" class="btn btn-soft-primary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-16 mb-0"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Robotic Body Art</a></h6>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card explore-box">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class="fs-16 mb-0"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Creative Filtered Portrait</a></h6>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="d-lg-flex align-items-center mb-4">
            ...
            <div class="flex-shrink-0 mt-4 mt-lg-0">
                <a href="{{ route('template.index', 'apps-nft-creators') }}" class="btn btn-soft-primary">View All <i class="ri-arrow-right-line align-bottom"></i></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Trendy Fashion Portraits</a></h5>
    ...
    <div class="col">
        <div class="card explore-box card-animate">
            ...
            <div class="card-body">
                ...
                <h5 class="mb-1"><a href="{{ route('template.index', 'apps-nft-item-details') }}">Smillevers Crypto</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="{{ route('template.index', 'pages-profile') }}">Tonya Noble</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="{{ route('template.index', 'pages-profile') }}">Kevin Dawson</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="{{ route('template.index', 'pages-profile') }}">Herbert Stokes</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="{{ route('template.index', 'pages-profile') }}">Thomas Taylor</a></h5>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="mt-3 mb-1"><a href="{{ route('template.index', 'pages-profile') }}">James Price</a></h5>
