                ...
                <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <div class="">
                                <a href="{{ route('template.index', 'auth-signin-basic') }}"
                                    class="btn btn-link fw-medium text-decoration-none text-dark">Sign
                                    in</a>
                                <a href="{{ route('template.index', 'auth-signup-basic') }}" class="btn btn-primary">Sign Up</a>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8 col-sm-10">
                                <div class="text-center mt-lg-5 pt-5">
                                    ...
                                    <div class="d-flex gap-2 justify-content-center mt-4">
                                        <a href="{{ route('template.index', 'auth-signup-basic') }}" class="btn btn-primary">Get Started <i
                                                class="ri-arrow-right-line align-middle ms-1"></i></a>
                                        <a href="{{ route('template.index', 'pages-pricing') }}" class="btn btn-danger">View Plans <i
                        ...
                        <div class="row align-items-center gy-4">
                            <div class="col-lg-6 order-2 order-lg-1">
                                <div class="text-muted">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('template.root') }}" class="btn btn-primary">Learn More <i
                                                class="ri-arrow-right-line align-middle ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        <div class="avatar-xl mx-auto mb-4 position-relative">
                                            ...
                                            <a href="{{ route('template.index', 'apps-mailbox') }}"
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="{{ route('template.index', 'pages-profile') }}" class="text-body">Nancy Martino</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="{{ route('template.index', 'pages-profile') }}" class="text-body">Henry Baird</a></h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="{{ route('template.index', 'pages-profile') }}" class="text-body">Frank Hook</a></h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="{{ route('template.index', 'pages-profile') }}" class="text-body">Donald Palmer</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="{{ route('template.index', 'pages-profile') }}" class="text-body">Erica Kernan</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="{{ route('template.index', 'pages-profile') }}" class="text-body">Alexis Clarke</a>
                                        </h5>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="{{ route('template.index', 'pages-profile') }}" class="text-body">Marie Ward</a></h5>
                                        <p class="text-muted mb-0 ff-secondary">Full Stack Developer</p>
                                    </div>
                                </div>
                                <!-- end card -->
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body text-center p-4">
                                        ...
                                        <!-- end card body -->
                                        <h5 class="mb-1"><a href="{{ route('template.index', 'pages-profile') }}" class="text-body">Jack Gough</a></h5>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="text-center mt-2">
                                    <a href="{{ route('template.index', 'pages-team') }}" class="btn btn-primary">View All Members <i
