@extends('template.layouts.layouts-horizontal')
@section('title')
                            ...
                            <div class="card-body p-0">
                                <div class="alert alert-warning border-0 rounded-0 m-0 d-flex align-items-center"
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="{{ route('template.index', 'pages-pricing') }}"
                                ...
                                <div class="row align-items-end">
                                    <div class="col-sm-8">
                                        <div class="p-3">
                                            ...
                                            <div class="mt-3">
                                                <a href="{{ route('template.index', 'pages-pricing') }}" class="btn btn-success">Upgrade
                                                    Account!</a>
                                            </div>
                                        </div>
                                    </div>
