                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Profile Page Structure</a></h6>
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="text-muted"
                                        id="dropdownMenuLink1" data-bs-toggle="dropdown"
                                        aria-expanded="false"><i class="ri-more-fill"></i></a>
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                        <li><a class="dropdown-item" href="{{ route('template.index', 'apps-tasks-details') }}"><i
                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                            <h6 class="fs-15 mb-0 text-truncate task-title">
                                                <a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Velzon - Admin Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <a href="javascript:void(0);" class="text-muted"
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                            <h6 class="fs-15 mb-0 text-truncate task-title">
                                                <a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Admin Layout Design</a>
                                            </h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <a href="javascript:void(0);" class="text-muted"
                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate task-title"><a
                                            href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Marketing & Sales</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <a href="javascript:void(0);" class="text-muted"
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Brand Logo
                                    Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Change Old
                                    App Icon</a></h6>
                ...
                <div id="reviews-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Create
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Product
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Create a
                        ...
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a
                                        href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Create a Blog Template UI</a>
                                </h6>
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="text-muted"
                ...
                <div id="new-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate task-title"><a href="{{ route('template.index', 'apps-tasks-details') }}" class="d-block">Banner
                ...
                <div class="modal-body">
                    <div class="mt-2 text-center">
                        <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop"
                            colors="primary:#AA83FF,secondary:#f06548" style="width:100px;height:100px">
                        </lord-icon>
