                                ...
                                <div class="text-center py-5">
                                    ...
                                    <div class="mb-4">
                                        <lord-icon src="https://cdn.lordicon.com/lupuorrc.json"
                                            trigger="loop" colors="primary:#0ab39c,secondary:#151426"
                                    ...
                                    <h3 class="fw-semibold">Order ID: <a
                                            href="{{ route('template.index', 'apps-ecommerce-order-details') }}"
                        ...
                        <table class="table table-borderless align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <h5 class="fs-14"><a href="{{ route('template.index', 'apps-ecommerce-product-details') }}"
