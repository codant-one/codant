                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                                ...
                                <div class="d-flex gap-1 align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="{{ route('template.index', 'apps-projects-overview') }}"><i
                                                    class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                View</a>
                                            <a class="dropdown-item" href="{{ route('template.index', 'apps-projects-create') }}"><i
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="{{ route('template.index', 'apps-projects-overview') }}"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-danger-subtle rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="{{ route('template.index', 'apps-projects-overview') }}"
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="fs-14 mb-3"><a href="{{ route('template.index', 'apps-projects-overview') }}" class="text-body">Kanban
                                Board</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="{{ route('template.index', 'apps-projects-overview') }}" class="text-body">Ecommerce
                                app</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="{{ route('template.index', 'apps-projects-overview') }}" class="text-body">Redesign -
                                Landing page</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="{{ route('template.index', 'apps-projects-overview') }}"
                                class="text-body">Multipurpose landing template</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
                ...
                <div class="modal-body">
                    <div class="mt-2 text-center">
                        <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop"
                            colors="primary:#AA83FF,secondary:#f06548" style="width:100px;height:100px"></lord-icon>
