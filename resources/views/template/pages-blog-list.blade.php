        ...
        <div class="col-xxl-9">
            <div class="row g-4 mb-3">
                <div class="col-sm-auto">
                    <div>
                        <a href="{{ route('template.index', 'apps-projects-create') }}" class="btn btn-success"><i
                        ...
                        <div class="card-body">
                            <div class="row g-4">
                                ...
                                <div class="col-xxl-9 col-lg-7">
                                    ...
                                    <a href="{{ route('template.index', 'pages-blog-overview') }}">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                        <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 05 Apr,
                                            ...
                                            451</span> | <a href="{{ route('template.index', 'pages-profile') }}"><i class="ri-user-3-line me-1"></i>
                                            Admin</a>
                                    </div>
                                    ...
                                    <a href="{{ route('template.index', 'pages-blog-overview') }}" class="text-decoration-underline">Read more <i
                                ...
                                <div class="col-xxl-9 col-lg-7">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                        <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 11 Feb,
                                            2024</span> | <span class="text-muted"><i class="ri-eye-line me-1"></i>
                                            713</span> | <a href="{{ route('template.index', 'pages-profile') }}"><i class="ri-user-3-line me-1"></i>
                                            Admin</a>
                                    </div>
                                ...
                                <div class="col-xxl-9 col-lg-7">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                        <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 09 July,
                                            2024</span> | <span class="text-muted"><i class="ri-eye-line me-1"></i>
                                            479</span> | <a href="{{ route('template.index', 'pages-profile') }}"><i class="ri-user-3-line me-1"></i>
                                            Admin</a>
                                    </div>
                                ...
                                <div class="col-xxl-9 col-lg-7">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                        <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 15 Sep,
                                            2024</span> | <span class="text-muted"><i class="ri-eye-line me-1"></i>
                                            174</span> | <a href="{{ route('template.index', 'pages-profile') }}"><i class="ri-user-3-line me-1"></i>
                                            Admin</a>
                                    </div>
                                ...
                                <div class="col-xxl-9 col-lg-7">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                        <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 24 Oct,
                                            2024</span> | <span class="text-muted"><i class="ri-eye-line me-1"></i>
                                            1926</span> | <a href="{{ route('template.index', 'pages-profile') }}"><i class="ri-user-3-line me-1"></i>
                                            Admin</a>
                                    </div>
                                ...
                                <div class="col-xxl-9 col-lg-7">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                        <span class="text-muted"><i class="ri-calendar-event-line me-1"></i> 20 Sept,
                                            2024</span> | <span class="text-muted"><i class="ri-eye-line me-1"></i>
                                            1337</span> | <a href="{{ route('template.index', 'pages-profile') }}"><i class="ri-user-3-line me-1"></i>
                                            Admin</a>
                                    </div>
