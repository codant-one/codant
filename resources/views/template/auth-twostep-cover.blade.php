                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p class="mb-0">Didn't receive a code ? <a href="{{ route('template.index', 'auth-pass-reset-cover') }}" class="fw-semibold text-primary text-decoration-underline">Resend</a> </p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end col -->
