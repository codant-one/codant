                    ...
                    <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                        ...
                        <tbody class="list form-check-all">
                            <tr>
                                ...
                                <td class="id"><a href="{{ route('template.index', 'apps-tasks-details') }}" class="fw-medium link-primary">#VLZ501</a></td>
                                <td class="project_name"><a href="{{ route('template.index', 'apps-projects-overview') }}" class="fw-medium link-primary">Velzon - v1.0.0</a></td>
                                <td>
                                    <div class="d-flex">
                                        <div class="flex-grow-1 tasks_name">Profile Page Satructure</div>
                                        <div class="flex-shrink-0 ms-4">
                                            <ul class="list-inline tasks-list-menu mb-0">
                                                <li class="list-inline-item"><a href="{{ route('template.index', 'apps-tasks-details') }}"><i class="ri-eye-fill align-bottom me-2 text-muted"></i></a>
                                                </li>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body p-5 text-center">
                <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop" colors="primary:#151426,secondary:#f06548" style="width:90px;height:90px"></lord-icon>
