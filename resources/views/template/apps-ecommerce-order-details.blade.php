                ...
                <div class="card-header">
                   <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('template.index', 'apps-invoices-details') }}" class="btn btn-success btn-sm"><i class="ri-download-2-fill align-middle me-1"></i> Invoice</a>
                        </div>
                   </div>
                </div>
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                           ...
                                           <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="{{ route('template.index', 'apps-ecommerce-product-details') }}" class="link-primary">Sweatshirt for Men (Pink)</a></h5>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                           ...
                                           <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="{{ route('template.index', 'apps-ecommerce-product-details') }}" class="link-primary">Noise NoiseFit Endure Smart Watch</a></h5>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                           ...
                                           <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="{{ route('template.index', 'apps-ecommerce-product-details') }}" class="link-primary">350 ml Glass Grocery Container</a></h5>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-center">
                        <lord-icon src="https://cdn.lordicon.com/uetqnvvg.json" trigger="loop" colors="primary:#151426,secondary:#0ab39c" style="width:80px;height:80px"></lord-icon>
