    ...
    <div class="col-xl-8">
        <div class="row align-items-center gy-3 mb-3">
            ...
            <div class="col-sm-auto">
                <a href="{{ route('template.index', 'apps-ecommerce-products') }}"
        ...
        <div class="card product">
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class="col-sm">
                        <h5 class="fs-14 text-truncate"><a href="{{ route('template.index', 'ecommerce-product-detail') }}"
        ...
        <div class="text-end mb-4">
            <a href="{{ route('template.index', 'apps-ecommerce-checkout') }}"
