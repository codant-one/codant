                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1"><a
                                                                    href="{{ route('template.index', 'apps-ecommerce-product-details') }}"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-14 my-1 fw-medium"><a
                                                                    href="{{ route('template.index', 'apps-ecommerce-seller-details') }}"
                        ...
                        <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                            <div class="acitivity-timeline acitivity-main">
                                ...
                                <div class="acitivity-item py-3 d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h6 class="mb-1 lh-base">Today offers by <a href="{{ route('template.index', 'apps-ecommerce-seller-details') }}"
