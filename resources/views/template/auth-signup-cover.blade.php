                                    ...
                                    <div class="col-lg-6">
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p class="mb-0">Already have an account ? <a href="{{ route('template.index', 'auth-signin-cover') }}" class="fw-semibold text-primary text-decoration-underline"> Signin</a> </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
