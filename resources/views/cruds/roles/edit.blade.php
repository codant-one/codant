...
<div class="container-fluid">
    <div class="mx-5 mx-xl-15 my-7">
        {!!  Form::open(['route' => ['roles.update', ['role' => $rol->id]], 'method' => 'PUT']) !!}     
        <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-5">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" class="form-check-input h-20px w-20px" id="check-all"  @if(auth()->user()->getRoleNames()[0] === 'Administrador' && ($rol->name === 'Administrador' || $rol->name === 'SuperAdmin')) disabled @endif>
                                        ...
                                        @foreach ($permissions as $permission)
                                            ...
                                            <div class="col-md-3 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input 
                                                        type="checkbox" 
                                                        class="form-check-input h-20px w-20px checkbox-permission" 
                                                        name="permissions[]" 
                                                        value="{{ $permission->id }}" 
            ...
            <div class="card-footer py-3 px-md-20 @if(auth()->user()->getRoleNames()[0] === 'Administrador' && ($rol->name === 'Administrador' || $rol->name === 'SuperAdmin')) d-none @endif">
                <div class="row text-center py-3 px-md-20">
                    <div class="col-12 col-md-6">
                        <a class="d-flex align-center justify-content-center btn btn-light me-3 w-100" href="{{ route('roles.index') }}">Regresar</a>
                    </div>
                    <div class="col-12 col-md-6">
