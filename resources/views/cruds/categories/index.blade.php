                ...
                <table id="kt_datatable_example_1" class="table align-middle table-row-bordered fs-6" style="width:100%">
                    <thead class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        <tr>
                            ...
                            <th class="w-200px">TIPO DE CATEGORÍA</th>
                            <th class="w-250px">NOMBRE (ES)</th>
                            <th class="w-250px">NOMBRE (EN)</th>
                        ...
                        <tr class="bg-white">
                            ...
                            <th>
                                <input type="text" class="form-control form-control-sm" placeholder="TIPO DE CATEGORÍA">
                            </th>
                            <th>
...
<script>
    $(document).ready(function () {
        ...
        var can = "{!!  auth()->user()->canany(['category_edit','category_delete']) !!}";
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a href="${ `{{ route("categories.edit", ["category" => 'here']) }}`.replace('here', row.id) }" class="text-dark fw-bolder text-hover-primary fs-6">
                                    ${title}
                                </a>`;
                    }
                },
