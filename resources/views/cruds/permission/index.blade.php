                ...
                <table id="kt_datatable_example_1" class="table align-middle table-row-bordered fs-6" style="width:100%">
                    <thead class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        <tr>
                            ...
                            <th class="w-800px">DESCRIPCIÓN</th>
                            <th class="w-200px">CREADO</th>
...
@php
$edit_route = route("permissions.edit", ["permission" => 'id-here']);
$delete_route = route("permissions.destroy", ["permission" => 'id-here']);
@endphp

<script>
    $(document).ready(function () {

        var actionsHtml = ` <div class="d-flex aling-center justify-content-center">
                                @can('permission_edit')    
        ...
        if(can) {
            columns = [
                ...
                { data: 'actions', defaultContent: '', render: function(data, type, row, meta){
